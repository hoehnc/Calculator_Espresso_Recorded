...
public class CalculatorActivityLTUTest {
    ...
    public void calculatorActivityLTUTest() {
        ...
        editText3.perform(replaceText("8"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.operation_result_text_view), withText("40.0"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        textView.check(matches(withText("40.0")));
