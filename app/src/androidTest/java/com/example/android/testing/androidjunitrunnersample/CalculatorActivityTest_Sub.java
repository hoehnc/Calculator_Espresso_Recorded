...
public class CalculatorActivityTest_Sub {
    ...
    public void calculatorActivityTest_Sub() {
        ...
        ViewInteraction button = onView(
                allOf(withId(R.id.operation_sub_btn), withText("Sub"), isDisplayed()));
        button.perform(click());

        ViewInteraction textView = onView(
                allOf(withId(R.id.operation_result_text_view), withText("-1.0"),
                        childAtPosition(
                                childAtPosition(
